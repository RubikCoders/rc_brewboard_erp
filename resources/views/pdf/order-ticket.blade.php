...
{{--                    Customizaciones --}}
    ...
    <table width="100%" style="border-collapse: collapse; margin-bottom: 2px; font-size: 12px;" class="total">
        ...
        <tr>
            <td></td>
            <td class="title" style="width: 60%; padding: 0;">@lang('order-ticket.tax')</td>
            <td class="title" style="text-align: right; padding: 0;">{{ \App\Helpers\Money::format($order->tax) }}</td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr class="title">
            <td></td>
            <td class="title" style="width: 60%; padding: 0;"><strong style="font-size: 16px">@lang('order-ticket.total')</strong></td>
            <td style="text-align: right; padding: 0;"><strong style="font-size: 16px;">{{ \App\Helpers\Money::format($order->total) }}</strong></td>
        </tr>
    </table>
